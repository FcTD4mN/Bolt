...
private:
    ...
    ::nVolumetric::nSparseOctree::cUSROCMap< ::nVolumetric::nSparseOctree::eLod2N::kLod256, ::nVolumetric::nSparseOctree::eLod2N::kLod8, ::nVolumetric::nSparseOctree::tByte > mMap2;
