...
private:
    ...
    ::nVolumetric::nSparseOctree::cUSROCMap< ::nVolumetric::nSparseOctree::eLod2N::kLod512, ::nVolumetric::nSparseOctree::eLod2N::kLod16, ::nVolumetric::nSparseOctree::tByte > mMap2;
