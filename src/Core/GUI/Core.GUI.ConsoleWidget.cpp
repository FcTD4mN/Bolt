    ...
    mPrintCacheIndex( 0 )
{
    ...
    ::nCore::nBoltScript::Env()->ProcessRawString( "output:SFML" );
...
{
    ::nCore::nBoltScript::Env()->RegisterFunction( "output:SFML",  [=](void) { HookOutput(); } );
    ::nCore::nBoltScript::Env()->RegisterFunction( "cls",          [=](void) { Clear(); } );
    ::nCore::nBoltScript::Env()->RegisterFunction( "help",         [=](void) { Print( "Not Available" ); } );
    ::nCore::nBoltScript::Env()->RegisterFunction( "minigame",     [=](void) { StartMiniGame(); } );
}
...
cConsoleWidget::HookOutput()
{
    ...
    ::nCore::nBoltScript::Env()->Print( ">>: Output switching to SFML Console \r\n");
    ::nCore::nBoltScript::Env()->SetOutputRedirectionFunction( f );
    ::nCore::nBoltScript::Env()->Print( ">>: Output switched to SFML Console \r\n");
}
...
{
    ::nCore::nBoltScript::Env()->ProcessRawString( mInputText.getString() );
}
...
cConsoleWidget::ProcessCTRLCPressed()
{
    ...
    ::nCore::nBase::SetClipboardText( str );
}
...
cConsoleWidget::ProcessCTRLVPressed()
{
    ...
    std::string clipboardStr = ::nCore::nBase::GetClipboardText();
