...
public:
    ...
    ~cStaticLodChunk32();
    cStaticLodChunk32();
    cStaticLodChunk32( tByte iVal );
    cStaticLodChunk32( const  cStaticLodChunk32& ) = delete;
...
public:
    // Neighbour Accessors
    cStaticLodChunk32*  GetNeighbour( eNF_Index  iNeighbourIndex )  const;
    void                SetNeighbour( eNF_Index  iNeighbourIndex, cStaticLodChunk32* iAdress );
