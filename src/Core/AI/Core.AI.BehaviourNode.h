...
public:
    ...
    virtual  void  AddNode( ::nCore::nAI::cBehaviourNode*  iNode );

    /** Inserts a Node at iIndex in the node list */
    virtual  void  InsertNode( int iIndex, ::nCore::nAI::cBehaviourNode*  Node );
...
public:
    ...
    virtual  void  AddService( ::nCore::nAI::cBehaviourService*  iService );

    /** Inserts a service at iIndex in the service list */
    virtual  void  InsertService( int iIndex, ::nCore::nAI::cBehaviourService*  iService );
...
private:
    std::vector< ::nCore::nAI::cBehaviourNode* > mNodes;
    std::vector< ::nCore::nAI::cBehaviourService* > mServices;
