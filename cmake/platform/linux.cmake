...
function(bolt_build_ext_libs extlib_dir extlib_install_path )
    ...
    bolt_build_extlib(CPYTHON "${extlib_dir}/cpython" "${extlib_install_path}" --enable-optimizations)

    set(EXTLIBS_DEPENDENCIES ${CMAKE_DL_LIBS} -lutil PARENT_SCOPE) 

    set(CMAKE_PREFIX_PATH ${extlib_install_path} ${CMAKE_PREFIX_PATH} PARENT_SCOPE)
